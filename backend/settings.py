...
SECRET_KEY = "django-insecure-)r2cw634pj@fk8(z4+o=!l62524_39@3vr)4u2u2to#v3r7@#v"
...
# If you plan to allow cross-origin requests (e.g., from React on another port):
...
INSTALLED_APPS = [
    ...
    # Local apps
    "backend.ml_app.apps.MlAppConfig",  # Update this line to point to the correct location
]
